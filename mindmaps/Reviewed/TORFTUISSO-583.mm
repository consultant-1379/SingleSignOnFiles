...
<node CREATED="1336037971857" ID="ID_150542004" MODIFIED="1364483867974" TEXT="TORFTUISSO-583">
<node CREATED="1336037984024" ID="ID_679454563" MODIFIED="1364484429076" POSITION="right" TEXT="Functional Tests">
<node CREATED="1362576605707" HGAP="36" ID="ID_1263812517" MODIFIED="1364484418109" TEXT="sSO_PolicyAgent_Install_1" VSHIFT="-61">
<node CREATED="1336039735424" ID="ID_1399826176" MODIFIED="1359130827194" TEXT="COMPONENT: SSO"/>
<node CREATED="1336038744773" ID="ID_293380175" MODIFIED="1364483979148" TEXT="DESCRIPTION: Use SI to stop Apache across both SC nodes"/>
...
<node CREATED="1336038860069" ID="ID_1207612622" MODIFIED="1364912504922" TEXT="PRE: 1 Node fully set up for SSO installation. JBoss running and configured. Apache web container running and configured. OpenAM installed and configured."/>
<node CREATED="1336038805518" ID="ID_1618316508" MODIFIED="1364912574413" TEXT="EXECUTE: Please refer to the Mindmap for TORFTUISSO-501 for test cases."/>

...
# UI Presentation Server container
litp /definition/jee1_container create component-def name=jee_container version=1.0.0
litp /definition/jee1_container/rpm create package-def name="3PP-jboss-eap_CXP9022745" ensure="installed" repository="Ammeon_Custom"
litp /definition/jee1_container/instance create jee-container-def name=jboss_torOAM instance-name={rdni} version=1.0.0 install-source=/opt/ericsson/nms/jboss/jboss-eap-6.0.1-no-mod-cluster-no-ajp.tar.gz log-dir='/var/log/jboss/{rdni}' data-dir='/home/jboss/{rdni}/jboss_data' home-dir='/home/jboss/{rdni}' process-user=litp_jboss  process-group=litp_jboss management-listener={ip.address} public-listener={ip.address} public-port-base=8080 management-user=root management-password=shroot command-line-options="-Djgroups.uuid_cache.max_age=5000" messaging-group-address='231.8.11.8' default-multicast='231.8.11.8' messaging-group-port='12100' jgroups-mping-mcast-addr='230.0.11.147' jgroups-mping-mcast-port='45100' jgroups-udp-mcast-addr='230.0.11.147' jgroups-udp-mcast-port='45103'
litp /definition/jee1_container/instance/preferIPv4Stack create jee-property-def property='-Djava.net.preferIPv4Stack' value=true
litp /definition/jee1_container/instance/gcInterval create jee-property-def property='-Dsun.rmi.dgc.server.gcInterval' value=300
litp /definition/jee1_container/instance/ip create ip-address-def pool=network net_name=mgmt

#STORY-5009
litp /definition/jee1_container/instance/jee_unsecure create jee-property-def property='-Djboss.bind.address.unsecure' value=127.0.0.1
#additional firewall rules to enable multicast traffic on the defined ports
litp /definition/jee1_container/instance/fw_jee1_container create firewalls-def name="006 jee torOAM" dport="12100,45100,45103"
...
litp /definition/sso1_container/rpm create package-def name="jboss-eap-6.0.1-sfwk-ms-sso-ha" ensure="installed" repository="Ammeon_Custom"
litp /definition/sso1_container/sso1 create jee-container-def name=sso1 instance-name={rdni} version=1.0.0 install-source=/opt/ericsson/nms/jboss/jboss-eap-6.0.1-no-mod-cluster-no-ajp.tar.gz log-dir='/var/log/jboss/{rdni}' data-dir='/var/lib/jboss/{rdni}' home-dir='/home/jboss/{rdni}' process-user=litp_jboss  process-group=litp_jboss public-listener='0.0.0.0' public-port-base=8080 management-listener='0.0.0.0' management-port-base=9990 management-port-native=9999 management-user=admin management-password=passw0rd port-offset=16030
...
litp /definition/sso1_container/sso1/defaultConfig create jee-property-def property='--server-config' value=standalone-sso.xml
litp /definition/sso1_container/sso1/fw_sso1 create firewalls-def name="006 sso1" dport="24110,26029,26020"

# litp /definition/sso1_container create component-def name=jee_container version=1.0.0
# litp /definition/sso1_container/sso1 create jee-container-def name=sso1 instance-name={rdni} version=1.0.0 install-source=/opt/ericsson/nms/jboss/jboss-eap-6.0.1-sfwk-ms-sso-ha-160113.tar.gz log-dir='/var/log/jboss/{rdni}' data-dir='/var/lib/jboss/{rdni}' home-dir='/home/jboss/{rdni}' messaging-group-address='231.7.7.7' default-multicast='231.7.7.7' messaging-group-port='12342' process-user=litp_jboss  process-group=litp_jboss public-listener='0.0.0.0' public-port-base=8080 management-listener='0.0.0.0' management-port-base=9990 management-port-native=9999 management-user=admin management-password=passw0rd port-offset=16030 command-line-options="-Djgroups.uuid_cache.max_age=5000" jgroups-bind-addr='127.0.0.1' jgroups-mping-mcast-addr='230.0.0.147' jgroups-mping-mcast-port='45831' jgroups-udp-mcast-addr='230.0.0.147' jgroups-udp-mcast-port='45843'
# litp /definition/sso1_container/sso1/preferIPv4Stack create jee-property-def property='-Djava.net.preferIPv4Stack' value=true
# litp /definition/sso1_container/sso1/gcInterval create jee-property-def property='-Dsun.rmi.dgc.server.gcInterval' value=300
# litp /definition/sso1_container/sso1/defaultConfig create jee-property-def property='--server-config' value=standalone-ha-sso.xml
# litp /definition/sso1_container/sso1/fw_sso1 create firewalls-def name="006 sso1" dport="24110,26029,26020"
...
# litp /definition/sso_app1 create component-def
# litp /definition/sso_app1/sso_rpm create package-def name=ERICsinglesignon_CXP9022934 version=1.7.12 ensure="installed" repository="Ammeon_Custom"

litp /definition/sso_app1 create component-def
litp /definition/sso_app1/sso_rpm create package-def name="ERICsinglesignon" ensure="installed" repository="Ammeon_Custom"

litp /definition/sso_app1/de1 create deployable-entity-def name=heimdallr version=1.1.1 install-source=/opt/ericsson/sso/resources/heimdallr.war app-type=war service=sso1 post-start=/opt/ericsson/sso/resources/jboss/jboss_app/post_start.d
...
litp /definition/deployment1/cluster1/node2/sso1 create component-ref component=sso1_container

# litp /definition/deployment1/cluster1/node1/sso_app1 create component-ref component=sso_app1
litp /definition/deployment1/cluster1/node2/sso_app1 create component-ref component=sso_app1
...
litp /definition/deployment1/cluster1/node2/apache1 create component-ref component=httpd_comp
...
# UI Deployment
litp /definition/cmw_installer/camp7 create cmw-campaign-def bundle_name="ERIC-httpd-CXP123456-R1A01" install_name="ERIC-httpd-UI-Camp"

# SSO Deployment
#litp /definition/cmw_installer/camp8 create cmw-campaign-def bundle_name="ERICsinglesignon_CXP9022934-1.7.12.noarch" install_name="ERIC-singlesignon_CXP9022934-camp"  bundle_type="rpm" 
...
# litp /definition/cmw_installer/camp7 create cmw-campaign-def bundle_name="ERIC-singlesignon-CXP9022934_1-R1A01" install_name="ERIC-singlesigon-I4-CXP9022034_1-R1A01" # jboss example app on 4 Nodes

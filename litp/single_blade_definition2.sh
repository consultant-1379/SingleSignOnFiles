...
# litp /definition/jee_container1/rpm create package-def name="3PP-jboss-eap_CXP9022745" ensure="installed" repository="Ammeon_Custom"
...
# Define Components
# Component - jboss 1
litp /definition/jee_container1 create component-def name=jee_container version=1.0.0
litp /definition/jee_container1/rpm create package-def name="jboss-eap-6.0.0-sfwk-ms-dps" ensure="installed" repository="Ammeon_Custom"
litp /definition/jee_container1/instance1 create jee-container-def name=jboss1 instance-name={rdni} version=1.0.0 install-source=/opt/ericsson/nms/jboss/jboss-eap-6.0.tgz log-dir='/var/log/jboss/{rdni}' data-dir='/home/jboss/{rdni}/jboss_data' home-dir='/home/jboss/{rdni}' process-user=litp_jboss  process-group=litp_jboss management-listener='0.0.0.0' public-listener='10.59.132.7' public-port-base=8080 management-user=root management-password=shroot command-line-options="-Djgroups.uuid_cache.max_age=5000" jgroups-bind-addr='10.59.132.7' 
litp /definition/jee_container1/instance1/preferIPv4Stack create jee-property-def property='-Djava.net.preferIPv4Stack' value=true
litp /definition/jee_container1/instance1/gcInterval create jee-property-def property='-Dsun.rmi.dgc.server.gcInterval' value=300
#litp /definition/jee_container1/instance1/ip create ip-address-def pool=network net_name=mgmt

# Component - application 1
litp /definition/security_app create component-def name=security_app version=1.0.0
litp /definition/security_app/pkg create package-def name="ERICsecuritysvc_CXP9023099" ensure="installed" repository="Ammeon_Custom"
litp /definition/security_app/de create deployable-entity-def name=securityservice version=1.1.1 install-source=/opt/ericsson/com.ericsson.nms.services/SecurityService-ear-1.0.9.ear app-type=ear service=jboss1
litp /definition/security_app/depends create depends-def name=jee_container min-version=1.0.0 scope=service-instance

# Define Service groups
litp /definition/deployment1/cluster1/sg1 create service-group-def node_list="sc1,sc2" availability_model="nway" version="1.0.1"
litp /definition/deployment1/cluster1/sg1/si create service-instance-def active-count=2 version="1.1.1"
litp /definition/deployment1/cluster1/sg1/si/jee_container1 create component-ref component="jee_container1"
litp /definition/deployment1/cluster1/sg1/si/security_app create component-ref component="security_app"
...
litp /definition/rd_rsyslog_server/rsyslog_server create rsyslog-server-def rlCentralHost="MS1"
...
litp /definition/rd_rsyslog_client/rsyslog_client create rsyslog-client-def rlCentralHost="MS1"
...
litp /definition/primary_node/syslog_central create component-ref component=rd_rsyslog_client
...
litp /definition/ms_node/syslog create component-ref component=rd_rsyslog_server

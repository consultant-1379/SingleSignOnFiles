...
litp /inventory/deployment1/network/range1 create ip-address-pool subnet=10.59.132.0/23 start=10.59.132.6 end=10.59.132.12 gateway=10.59.132.1
litp /inventory/deployment1/network/ip_10_59_132_4 create ip-address subnet=10.59.132.0/23 address=10.59.132.4 gateway=10.59.132.1
litp /inventory/deployment1/network/ip_10_59_132_4 enable


#we need to update the si_1 and assigne jboss instance ip addresses from sc-2
#sc-1, sc-2 are being assigned ip addresses in the ascending order sc-1 - .18, sc-2 - .19 (as the pool start is .17)
litp /inventory/deployment1/cluster1/sg1/si_1/jee_container1/instance1/ update jgroups-bind-addr="10.59.132.8"
litp /inventory/deployment1/cluster1/sg1/si_1/jee_container1/instance1/ update public-listener="10.59.132.8"
...
#
litp /inventory/deployment1/tipc create tipc-address-pool netid="4005"
...
litp /inventory/deployment1/systems/blade create generic-system macaddress="B4:B5:2F:5A:73:08" hostname="ms1"
...
litp /inventory/deployment1/systems/vm_pool create vm-pool mac_start='DE:AD:BE:EF:03:82' mac_end='DE:AD:BE:EF:03:87'
